<template>
  <div class="q-pa-md">
    <q-table grid grid-header flat bordered title="Plantas Alimenticias" :rows="rows.reverse()" :columns="columns"
...
const get = async () => {
  const query = await fetch(host + 'api/categories/Alimenticias')
