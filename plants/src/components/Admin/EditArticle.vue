...
Form(:validation-schema='schema')
    ...
    q-btn(color="purple" label="Editar Articulo" class="q-mb-xl" @click="validateArticle()")
</template>
...
const getArticle = async () => {
  const request = await fetch(`https://jfuton.pythonanywhere.com/api/articles/${article}/`)
